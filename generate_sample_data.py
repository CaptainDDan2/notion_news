...
sample_articles = [
    {
        ...
        "url": "https://example.com/samsung-3nm-breakthrough",
        "source": "EE Times",
        "priority_score": 9,
    ...
    },
    {
        ...
        "url": "https://example.com/intel-ai-strategy",
        "source": "AnandTech",
        "priority_score": 8,
    ...
    },
    {
        ...
        "url": "https://example.com/tsmc-2nm-acceleration",
    ...
    },
    {
        ...
        "url": "https://example.com/qualcomm-5g-chipset",
    ...
    },
    {
        ...
        "url": "https://example.com/sk-hynix-hbm4",
        "source": "EE News",
        "priority_score": 8,
    ...
    },
    {
        ...
        "url": "https://example.com/amd-epyc-datacenter",
    ...
    },
    {
        ...
        "url": "https://example.com/micron-ddr5-capacity",
        "source": "EDN Network",
        "priority_score": 6,
    ...
    },
    {
        ...
        "url": "https://example.com/arm-cpu-architecture",
    ...
    },
    {
        ...
        "content": "글로벌파운드리가 자동차 반도체와 IoT 칩을 위한 22FDX와 12LP+ 특수 공정 기술 확장에 50억 달러를 투자한다고 발표했습니다. 이는 홀두막 성장하는 전기차 시장과 스마트 IoT 디바이스 수요에 대응하기 위한 전략입니다. 22FDX 공정은 저전력과 고성능을 동시에 요구하는 자동차 ADAS 칩과 마이크로컨트롬러에 최적화되어 있으며, 12LP+ 공정은 엣지 AI 칩과 5G RF 소자 산업에 특화되어 있습니다. 이를 통해 TSMC와 삼성의 최첫단 공정 경쟁에서는 비켜서더라도 특수 용도 시장에서의 입지를 강화하려는 목표입니다.",
        "url": "https://example.com/globalfoundries-expansion",
        "source": "SemiMedia",
        "priority_score": 5,
